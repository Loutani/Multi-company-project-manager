                   ...
                   <div class="card car-transparent">
                      <div class="card-body p-0">
                         <div class="profile-image position-relative">
                            <img src="{{asset('template/images/page-img/profile.png')}}" class="img-fluid rounded w-100" alt="profile-image">
                         </div>
                      </div>
                   </div>
                </div>
                      ...
                      <div class="card-body">
                         <div class="d-flex align-items-center mb-3">
                            <div class="profile-img position-relative">
                               <img src="{{asset('template/images/user/1.jpg')}}" class="img-fluid rounded avatar-110" alt="profile-image">
                            </div>
                            <div class="ml-3">
                         ...
                         <ul class="list-inline p-0 m-0">
                            ...
                            <li class="mb-2">
                               <div class="d-flex align-items-center">
                                  ...
                                  <p class="mb-0">{{$profile->birthdate}}</p>   
                               </div>
                            </li>
                            <li class="mb-2">
                               <div class="d-flex align-items-center">
